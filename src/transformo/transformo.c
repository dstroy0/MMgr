 ...
 * @return             MMGR_TRUE when the digit was appended, MMGR_FALSE when *args->mant was
 *                     already too large.
...
#define MUTO_ENTRY(ReturnType_, name_, ...)                                                                            \
    GENERIC_ENTRY(mmgr_muto_, muto_, MutoCtx, TransformoCfg, ReturnType_, name_, __VA_ARGS__)

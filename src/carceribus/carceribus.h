...
/**
 * @brief Round @p n up to MMGR_CARCER_ALIGN.
 * @param n Byte count.
 ...
 * @param a Tenant.
 * @param n Byte count.
 * @param align Alignment, clamped into MMGR_CARCER_ALIGN..MMGR_CARCER_MAX_ALIGN.
...
typedef struct
{
    mmgr_carcer region[MMGR_CARCER_MAX_REGIONS]; /**< The tenants. */
...
typedef struct
{
    size_t top[MMGR_CARCER_MAX_REGIONS]; /**< Each region's fill point. */

...
typedef struct
{
    uint8_t *const buf;            const size_t cap;              const size_t nsegs;            _Atomic mmgr_word *const held; } RingCfg;

typedef struct
{
    const void *const owner;     const size_t gran;       } SingularitasCfg;

typedef struct
{
    mmgr_ring *const r;                struct MmgrCursor *const cur;      uint8_t *const dst;                const uint8_t *const src;          const size_t n;                    const size_t off;                  const size_t from;                 const size_t to;                   size_t *const tessera;             const void *const owner;           const SingularitasCfg *const sing;     size_t *const units;                   mmgr_u16 *const status;            } InfinCfg;

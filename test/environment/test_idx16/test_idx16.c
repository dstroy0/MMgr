...
//
// Environment suite: idx16.
//
// a 16-bit index against the host's word
//
...
void test_idx16_widths_are_what_was_asked_for(void)
{
    TEST_ASSERT_EQUAL_INT_MESSAGE(16, MMGR_INDEX_BITS, "MMGR_INDEX_BITS did not reach the translation unit");
...
void test_idx16_types_match_the_widths(void)
{

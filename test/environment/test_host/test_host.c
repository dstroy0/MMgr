...
//
// Environment suite: host.
//
// the machine's own widths, derived from UINTPTR_MAX
//
...
void test_host_widths_are_what_was_asked_for(void)
{
    // Nothing is overridden here: the point is that the derived defaults are coherent.
...
void test_host_types_match_the_widths(void)
{

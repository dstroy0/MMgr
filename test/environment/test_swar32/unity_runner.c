...
int main(void)
{
  ...
  run_test(test_swar32_widths_are_what_was_asked_for, "test_swar32_widths_are_what_was_asked_for", 16);
  run_test(test_swar32_types_match_the_widths, "test_swar32_types_match_the_widths", 31);

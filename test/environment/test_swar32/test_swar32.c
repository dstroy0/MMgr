...
void test_swar32_widths_are_what_was_asked_for(void)
{
    TEST_ASSERT_EQUAL_INT_MESSAGE(32, MMGR_SWAR_BITS, "MMGR_SWAR_BITS did not reach the translation unit");
...
void test_swar32_types_match_the_widths(void)
{

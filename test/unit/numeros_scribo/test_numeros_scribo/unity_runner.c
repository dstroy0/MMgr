...
int main(void)
{
  ...
  run_test(test_build_renders_a_spec, "test_build_renders_a_spec", 112);
  run_test(test_build_rejects_a_value_of_the_wrong_kind, "test_build_rejects_a_value_of_the_wrong_kind", 122);
  run_test(test_build_rejects_too_few_and_too_many_values, "test_build_rejects_too_few_and_too_many_values", 132);
  run_test(test_build_guards_its_arguments, "test_build_guards_its_arguments", 144);
  run_test(test_build_of_a_spec_with_only_literals, "test_build_of_a_spec_with_only_literals", 155);
  run_test(test_build_covers_every_kind, "test_build_covers_every_kind", 163);
  run_test(test_build_covers_the_width_bearing_kinds, "test_build_covers_the_width_bearing_kinds", 175);
  run_test(test_build_of_a_null_string_value, "test_build_of_a_null_string_value", 188);
  run_test(test_build_overflow_leaves_an_empty_buffer, "test_build_overflow_leaves_an_empty_buffer", 201);
  run_test(test_build_rejects_an_unknown_kind, "test_build_rejects_an_unknown_kind", 209);
  run_test(test_append_builds_on_what_is_there, "test_append_builds_on_what_is_there", 219);
  run_test(test_append_guards_its_arguments, "test_append_guards_its_arguments", 230);
  run_test(test_append_that_does_not_fit_leaves_the_original, "test_append_that_does_not_fit_leaves_the_original", 238);
  run_test(test_append_to_a_full_buffer, "test_append_to_a_full_buffer", 246);
  run_test(test_emit_guards_its_arguments, "test_emit_guards_its_arguments", 253);
  run_test(test_emit_append_guards_its_arguments, "test_emit_append_guards_its_arguments", 259);
  run_test(test_emit_covers_the_width_bearing_kinds, "test_emit_covers_the_width_bearing_kinds", 265);
  run_test(test_a_g_field_with_no_width_gets_six_digits, "test_a_g_field_with_no_width_gets_six_digits", 275);
  run_test(test_a_hex_field_with_no_width_gets_one_digit, "test_a_hex_field_with_no_width_gets_one_digit", 290);
  run_test(test_an_oct_field_with_no_width_gets_one_digit, "test_an_oct_field_with_no_width_gets_one_digit", 300);
  run_test(test_append_to_a_buffer_with_no_terminator_is_refused, "test_append_to_a_buffer_with_no_terminator_is_refused", 307);
  run_test(test_an_append_that_does_not_fit_puts_the_terminator_back, "test_an_append_that_does_not_fit_puts_the_terminator_back", 319);
  run_test(test_the_variadic_path_carries_every_kind, "test_the_variadic_path_carries_every_kind", 329);
  run_test(test_a_u64_of_its_largest_value, "test_a_u64_of_its_largest_value", 343);
  run_test(test_an_emit_append_that_does_not_fit_puts_the_terminator_back, "test_an_emit_append_that_does_not_fit_puts_the_terminator_back", 350);

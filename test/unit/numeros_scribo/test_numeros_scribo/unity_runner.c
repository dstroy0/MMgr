...
int main(void)
{
  ...
  run_test(test_numer_header_is_self_contained, "test_numer_header_is_self_contained", 15);
  run_test(test_numer_namespace_is_wired, "test_numer_namespace_is_wired", 22);

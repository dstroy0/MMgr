...
int main(void)
{
  ...
  run_test(test_bitio_header_is_self_contained, "test_bitio_header_is_self_contained", 15);
  run_test(test_bitio_namespace_is_wired, "test_bitio_namespace_is_wired", 22);

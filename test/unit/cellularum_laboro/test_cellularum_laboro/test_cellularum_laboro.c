...
//
// Unit suite for src/cellularum_laboro.
//
...
void test_cellul_header_is_self_contained(void)
{
    TEST_PASS_MESSAGE("cellularum_laboro.h compiled with no header before it");
}
...
void test_cellul_namespace_is_wired(void)
{
    const CellularumLaboroNs *ns = &cellul;
    TEST_ASSERT_NOT_NULL(ns);
    TEST_ASSERT_EQUAL_size_t_MESSAGE(sizeof(CellularumLaboroNs), sizeof(*ns),

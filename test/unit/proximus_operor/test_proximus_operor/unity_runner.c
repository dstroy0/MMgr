...
int main(void)
{
  ...
  run_test(test_proxim_header_is_self_contained, "test_proxim_header_is_self_contained", 15);
  run_test(test_proxim_namespace_is_wired, "test_proxim_namespace_is_wired", 22);

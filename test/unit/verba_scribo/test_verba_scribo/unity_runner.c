...
int main(void)
{
  ...
  run_test(test_verba_header_is_self_contained, "test_verba_header_is_self_contained", 15);
  run_test(test_verba_namespace_is_wired, "test_verba_namespace_is_wired", 22);

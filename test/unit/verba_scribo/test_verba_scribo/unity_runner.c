...
int main(void)
{
  ...
  run_test(test_fixed_rounds_a_tie_to_even, "test_fixed_rounds_a_tie_to_even", 290);
  run_test(test_fixed_is_exact_below_a_64_bit_shift, "test_fixed_is_exact_below_a_64_bit_shift", 335);
  run_test(test_g_rounds_a_tie, "test_g_rounds_a_tie", 374);
  run_test(test_g_matches_printf, "test_g_matches_printf", 394);
  run_test(test_g_and_fixed_of_the_specials, "test_g_and_fixed_of_the_specials", 411);
  run_test(test_overflow_latches_and_finish_reports_it, "test_overflow_latches_and_finish_reports_it", 437);
  run_test(test_writes_after_overflow_are_ignored, "test_writes_after_overflow_are_ignored", 445);
  run_test(test_each_entry_can_overflow_on_its_own, "test_each_entry_can_overflow_on_its_own", 461);
  run_test(test_a_zero_capacity_builder_cannot_write, "test_a_zero_capacity_builder_cannot_write", 484);
  run_test(test_the_literal_helper, "test_the_literal_helper", 491);
  run_test(test_namespace_is_wired, "test_namespace_is_wired", 498);
  run_test(test_the_clipping_entries_stay_quiet_after_overflow, "test_the_clipping_entries_stay_quiet_after_overflow", 512);
  run_test(test_put_clip_of_null_writes_nothing, "test_put_clip_of_null_writes_nothing", 526);
  run_test(test_put_clip_with_no_room_left_writes_nothing, "test_put_clip_with_no_room_left_writes_nothing", 533);
  run_test(test_u64_clip_that_does_not_fit_writes_nothing, "test_u64_clip_that_does_not_fit_writes_nothing", 545);
  run_test(test_xml_of_null_writes_nothing, "test_xml_of_null_writes_nothing", 552);
  run_test(test_fixed_of_nan, "test_fixed_of_nan", 566);
  run_test(test_fixed_of_the_infinities, "test_fixed_of_the_infinities", 575);
  run_test(test_fixed_of_a_value_too_large_for_the_integer_path, "test_fixed_of_a_value_too_large_for_the_integer_path", 587);
  run_test(test_fixed_of_a_value_with_no_fraction_left, "test_fixed_of_a_value_with_no_fraction_left", 598);
  run_test(test_fixed_clamps_its_decimals, "test_fixed_clamps_its_decimals", 605);
  run_test(test_fixed_carries_a_fraction_that_rounds_to_one, "test_fixed_carries_a_fraction_that_rounds_to_one", 616);
  run_test(test_fixed_of_negative_zero, "test_fixed_of_negative_zero", 624);
  run_test(test_g_of_nan, "test_g_of_nan", 635);
  run_test(test_g_of_zero, "test_g_of_zero", 642);
  run_test(test_g_of_a_very_small_value, "test_g_of_a_very_small_value", 650);
  run_test(test_g_of_a_very_large_value, "test_g_of_a_very_large_value", 658);
  run_test(test_g_of_one_significant_digit, "test_g_of_one_significant_digit", 666);
  run_test(test_g_of_zero_significant_digits_is_one, "test_g_of_zero_significant_digits_is_one", 677);
  run_test(test_json_escapes_the_two_character_forms, "test_json_escapes_the_two_character_forms", 694);
  run_test(test_json_escapes_the_named_control_bytes, "test_json_escapes_the_named_control_bytes", 701);
  run_test(test_json_escapes_an_unnamed_control_byte_as_a_code_point, "test_json_escapes_an_unnamed_control_byte_as_a_code_point", 710);
  run_test(test_json_overflows_on_each_escape_form, "test_json_overflows_on_each_escape_form", 718);
  run_test(test_finish_of_a_zero_capacity_builder_reports_nothing, "test_finish_of_a_zero_capacity_builder_reports_nothing", 734);
  run_test(test_g_over_every_precision, "test_g_over_every_precision", 749);
  run_test(test_g_of_a_subnormal, "test_g_of_a_subnormal", 774);
  run_test(test_g_of_the_largest_finite_double, "test_g_of_the_largest_finite_double", 786);
  run_test(test_is_inf_says_no_to_a_nan, "test_is_inf_says_no_to_a_nan", 794);
  run_test(test_fixed_over_every_decimal_count, "test_fixed_over_every_decimal_count", 805);
  run_test(test_fixed_of_a_fraction_that_lands_on_a_tie, "test_fixed_of_a_fraction_that_lands_on_a_tie", 827);
  run_test(test_g_where_the_exponent_estimate_overshoots, "test_g_where_the_exponent_estimate_overshoots", 845);
  run_test(test_g_clamps_its_digit_count, "test_g_clamps_its_digit_count", 910);
  run_test(test_g_at_its_maximum_still_reads_back, "test_g_at_its_maximum_still_reads_back", 926);
  run_test(test_g_at_two_to_the_sixty_four, "test_g_at_two_to_the_sixty_four", 938);
  run_test(test_g_is_exact_at_every_precision_it_can_carry, "test_g_is_exact_at_every_precision_it_can_carry", 948);
  run_test(test_g_of_the_smallest_normal_double, "test_g_of_the_smallest_normal_double", 971);

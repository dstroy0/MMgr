...
int main(void)
{
  ...
  run_test(test_endian_header_is_self_contained, "test_endian_header_is_self_contained", 15);
  run_test(test_endian_namespace_is_wired, "test_endian_namespace_is_wired", 22);

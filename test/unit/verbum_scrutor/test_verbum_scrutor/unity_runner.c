...
int main(void)
{
  ...
  run_test(test_scrut_header_is_self_contained, "test_scrut_header_is_self_contained", 15);
  run_test(test_scrut_namespace_is_wired, "test_scrut_namespace_is_wired", 22);

...
due. Same fixture, one difference. A divergence in outcome is the arm and nothing else - which is
 ...
 *       differs. A row that disagrees between the two is the arm and nothing else.

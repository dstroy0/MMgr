...
for name, macro, fn, doc in PROFILES:
    ...
    body = "\n".join(rows)
    guard = f"MMGR_ANCHOR_COST_{name.upper()}_H"
    p = OUT / f"anchor_cost_{name}.h"

...
All 83 disagreements the check reports on `2013_Lindley_Lyon` fall in these classes now that it has been read off the pages in full, and nothing else does. The last of them does not occur in that paper. That count is the measurement the draft exists to produce.
